...
export default function MindMapCollectionEditor() {
  ...
  return <div className="mmc-page">
    <style>{`
      ...
      @media (max-width:620px) { .mmc-page { grid-template-columns:1fr; gap:20px; }.mmc-library { min-height:0; }.mmc-map-list { grid-template-columns:repeat(2,minmax(0,1fr)); }.mmc-new-map { margin-top:12px; }.mmc-stage { min-height:430px; }.mmc-tree { min-width:480px; padding:28px 28px 36px; }.mmc-inspector { grid-column:auto; grid-template-columns:1fr; }.mmc-actions { grid-template-columns:repeat(2,minmax(0,1fr)); }.mmc-actions .primary { grid-column:1/-1; } }
    `}</style>
