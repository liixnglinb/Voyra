...
export default function ScheduleHub() {
  ...
  return <div className="shub-page">
    <style>{`
      ...
      .shub-mode.is-active { border-color:#1b1b1b; background:#1b1b1b; color:#fff; box-shadow:0 10px 22px -16px rgba(20,20,20,.7); }
      .shub-mode.is-active svg { color:#ffe08a; }
      .shub-mode.is-active .shub-mode-copy b { color:#fff; }
      .shub-mode.is-active .shub-mode-copy i { color:rgba(255,255,255,.62); }
