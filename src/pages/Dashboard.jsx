...
export default function Dashboard() {
  ...
  return <div className="vr-home" ref={rootRef}>
    ...
    <header className="vr-top"><span className="vr-brand">VOYRA<sup>®</sup></span><a className="vr-github" href="https://github.com/liixnglinb" target="_blank" rel="noreferrer"><Github size={15} />github.com/liixnglinb</a><a className="vr-github" href="https://apilxl.bbroot.com/modelflow/" target="_blank" rel="noreferrer" style={{border:"1px solid rgba(27,27,27,.18)",borderRadius:99,padding:"6px 12px"}}>⬇ 下载软件</a></header>
