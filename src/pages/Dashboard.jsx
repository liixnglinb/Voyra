  ...
  if (type === 'tokenmonitor') {
    ...
    return <div ref={artRef} onPointerEnter={() => { pausedRef.current = true; }} onPointerLeave={() => { pausedRef.current = false; }} className="vr-art vr-tool-art vr-tm-art">
      ...
      <div className="vr-tm-kpi">
        <div className={active === 0 ? 'is-on' : ''}><span>TOKENS</span><b>3.50 B</b><em>缓存命中 82.3%</em></div>
        <div className={active === 1 ? 'is-on' : ''}><span>API 请求</span><b>12,099</b><em>逐条计价</em></div>
        <div className={active === 2 ? 'is-on' : ''}><span>估算成本</span><b>&#165;9,335</b><em>按模型单价</em></div>
      </div>
