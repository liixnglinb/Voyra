...
import { guardDB, ensure, requireAdmin, ALPHABET, now, json, preflight, readBody, hashCode, encryptCode } from "../../../_mf.js";
...
export async function onRequestPost({ request, env }) {
  ...
  for (let i = 0; i < n; i++) {
    ...
    await env.DB.prepare("INSERT INTO codes(code,note,is_admin,created_at,code_enc) VALUES(?,?,?,?,?)")
      .bind(codeHash, note, isAdmin, t, codeEnc).run();
